...
<section id="editArtikel" class="container-fluid">
	<article class="container" id="questiondiv">
        <h1 class="text-center margintop80 marginbottom40"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Frage Editieren</h1>
		<article class="row">
			    ...
			    <form class="form-group" action="/create" method="POST">
                    ...
                    <div class="col-sm-12 col-md-12 margintop15">
                        <div class="col-sm-offset-2 col-sm-8 col-md-offset-2 col-md-8">
                            ...
                            <input type="button" onclick="editQuestion()" class="btn btn-black messagebtn marginbottom40" value="Editieren">
